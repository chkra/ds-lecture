...
> 💡 A very interesting project called [Charticulator](https://charticulator.com) offers a free drag and drop interface for data visualizations. In one of their tutorials they also use this mushroom dataset! So you can explore the data and learn the library at the same time: [Charticulator tutorial](https://charticulator.com/tutorials/tutorial4.html).

## Get to know your mushrooms 🍄

Mushrooms are very interesting. Let's import a dataset to study them. You can [find the data here]('../../data/mushrooms.csv') und study it with this modules [notebook](./notebook.ipynb).
...
As a challenge, try recreating these tasty charts in [Charticulator](https://charticulator.com).
