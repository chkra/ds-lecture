...
![Architektur des Autoencoders](/modules/autoencoder/img/Autoencoder.png)
...
![](/modules/autoencoder/img/fake-trump-800x800.jpeg)
Bekanntes Beispiel: [Deep Fakes, die Festnahmen von Donald Trump zeigen](https://arstechnica.com/tech-policy/2023/03/fake-ai-generated-images-imagining-donald-trumps-arrest-circulate-on-twitter/). Erstellt mit Midjourney, welches im Kern seiner Architektur auf Autoencodern basiert.
...
Diese Lektion folgt im Wesentlichen dem Text "Was ist ein Autoencoder" von Data Base Camp [Link](https://databasecamp.de/ki/autoencoder).
{: .notice--info}